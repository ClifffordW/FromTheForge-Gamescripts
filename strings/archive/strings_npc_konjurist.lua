return
{
	QUIPS = {
		...
		--for if theyve already bought one upgrade and are going to do so again
		SHOP_HAS_UPGRADED = {	
			[[
				agent:
					!notebook
			...
			starting_forest = {
				...
				OPT_EXPLAIN_YAMMO_RESPONSE = [[
					agent:
						...
						!notebook
						Anyway-- did you want to look at your <#RED>Upgrade</> options?
				]],
				...
				OPT_KILLED_YAMMO_RESPONSE = [[
					agent:
						...
						Haha, nice.
						!notebook
						Anyway, uh... did you want to look at your <#RED>Upgrade</> options?
				]],
				--END TREEMON BRANCH--
