...
return {
  __displayName="sound_corestones",
  anim_events={
    power_drop_generic={
      idle={
        done=true,
  ...
  prefab={
    { baseanim="1", prefab="soul_drop_konjur_soul_lesser",},
    { baseanim="1", prefab="soul_drop_konjur_soul_lesser_x2",},
    { baseanim="1", prefab="soul_drop_konjur_soul_lesser_many",},
  },
}
