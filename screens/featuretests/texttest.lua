...
function TextTest:DoInit()
	...
	self:AddChild(Text(FONTFACE.DEFAULT,50))
		:SetText("Embedded <p img='images/bg_title/title.tex' color=00ff0080 scale=2 rotation=45> images and <p bind='Controls.Digital.MENU_ACCEPT' color=RED> controller <p bind='Controls.Digital.MENU_TAB_NEXT'> icons <c img='lt' rotation=-20>")
		:SetHAlign(ANCHOR_RIGHT)
		:SetPosition(0,-320)
		:SetShadowColor(UICOLORS.RED)
	self:AddChild(Text(FONTFACE.DEFAULT,30))
		:SetTextRaw("Embedded <p img='images/bg_title/title.tex' color=00ff0080 scale=2 rotation=45> images and <p bind='Controls.Digital.MENU_ACCEPT' color=RED> controller <p bind='Controls.Digital.MENU_TAB_NEXT'> icons <c img='lt' rotation=-20>")
		:SetHAlign(ANCHOR_RIGHT)
		:SetPosition(0,-355)
		:SetGlyphColor(UICOLORS.GOLD)
