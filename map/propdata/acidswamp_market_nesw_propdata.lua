return {
  ...
  dummy_woworm={ { x=10.0,}, { x=12.0, z=-2.0,},},
  lightspot_circle={
    {
      script_args={
        animate=false,
        intensity=0.75400000810623,
        light_color="A050C2FF",
        max_rotation=20,
        max_translation=0.5,
        rot_speed=0.66666666666667,
        rotation=0,
        scale=7.0739998817444,
        shimmer=false,
        shimmer_speed=3,
